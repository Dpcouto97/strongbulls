            ...
            <div class="max-w-7xl mx-auto sm:px-4 lg:px-8">
                <div class="main-content">
                    ...
                    <div class="title-container flex items-center space-x-2">
                        <img :src="locationIcon" alt="location" class="w-10 h-10" />
...
import LocationModal from "@/Components/Modals/Location/locationModal.vue";
...
const deleteItem = async (id) => {
    try {
        ...
        await ElMessageBox.confirm("Are you sure you want to delete this location?", {
        ...
        ElNotification({
            title: "Error",
            message: error.response?.data?.message || "Failed to delete the location.",
            type: "error",
            duration: 2000,
        });
    }
